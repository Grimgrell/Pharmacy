...
public class PlaceArrayAdapter extends ArrayAdapter<PlaceArrayAdapter.PlaceAutocomplete> implements Filterable {
    ...
    private ArrayList<PlaceAutocomplete>getPredictions(CharSequence constraint){
        if(mGoogleApiClient != null){
            Log.i(TAG,"Exe autocomplete for: " +constraint);
            ...
            if(!status.isSuccess()){
                ...
                Log.e(TAG, "Error getting place prediction: " + status.toString());
                autocompletePredictions.release();
                return null;
            }
            Log.i(TAG, "Query completed. Recieved " + autocompletePredictions.getCount() + " predictions");
